...
public class FlightSeatingApplication extends Application {
    ...
    //Setup seats for customer objects
    ...
    //Displays the seating allocation as text
    ...
    //Allocates a selected seat option for a customer
            ...
            if((seatsList.get(x).getSeatClass() == cust.getClassType()) && (seatsList.get(x).getSeatType() == cust.getSeatType()))
            {
                if(seatsList.get(x).getCust() == null)
                {
                    ...
                    case "Adult":
                        ...
                        break;
                    case "Child":
                        seatarray[seatsList.get(x).getSeatRow()-1][seatsList.get(x).getSeatNumber()-1] = "C";
                        break;
                    }
    ...
    //Cancels the seat allocation for customer
